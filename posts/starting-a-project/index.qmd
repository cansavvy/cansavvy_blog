...
III.
IV. A summary of what this has covered and a reminder of why this is so important. 
```
...
Find articles that are related? Dump the links to those (no need to read them thoroughly at the get go, just dump them all in there). 
